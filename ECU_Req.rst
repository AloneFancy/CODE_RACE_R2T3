...
<description of the requirement in requirements language>
VEHICLE_SYSTEM_BEHAVIOUR<Optional: description of desired vehicle behaviour ("development target")>    CONSTRAINT    <Optional: constraints on the solution space for the requirement>IMPACT    <Optional: description of possible cross-functional impact of the requirement, or impact on other components>INFO<Optional: additional informations about the requirement:- know-how- background- HW dependencies related to the system requirement- internal signals- etc>ASSUMPTION<Optional: assumptions on the requirement>
 
